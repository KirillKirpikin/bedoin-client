...
const SingleCoffeePage = () => {
    ...
    const options= useMemo(()=>['У зерні', 'Джезва (турка)', 'Домашня кавоварка', 'Еспресо', 'V-60', 'Аеропресс', 'Фільтр', 'Френч-прес', 'Кемекс', 'Гейзерна кавоварка'], []);
    const {id} = useParams();
        ...
        <div className='single-product'>
            <div className="single-product__container">
                <div className="navigate">
                    ...
                    <ArrowSvg/>
                    <Link className='navigate__link' to={ROUTES.COFFEE}>кава</Link>
                    <ArrowSvg/>
                    <div className='navigate__link navigate__link-this'>{!data ? 'кава' :data.title}</div>
                </div>
                {isLoading ?(
                    ...
                    :data ? (
                        <>
                            <div className="single-product__main main-product">
                                <div className="main-product__top">
                                    <div className="main-product__slider">
                                        <SliderSingle img={memoizedImages} currentRadio={currentRadio}/>
                                    </div>
                                    <div className="main-product__info">
                                        ...
                                        <div className="main-product__prices">
                                            <div className="main-product__price">
                                                ...
                                                <div>{currentRadio === 1 ? data.price.standart.regular : data.price.kg.regular} ₴</div>
                                            </div>
                                            <div className="main-product__price">
                                        ...
                                        <div className="main-product__options">
                                            <div className='main-product__select'>
                                                <Select arr={options} selected={selected} setSelected = {setSelected} /> 
                                            </div>
                                            <div className='main-product__radio'>
                                                <CustomRadio value={weight} current={currentRadio} setCurrent={setCurrentRadio}/>
                                            </div>
                                        </div>
                            ...
                            <div className="single-product__info info-product">
                                ...
                                <h3 className="info-product__title">більше про каву</h3>
