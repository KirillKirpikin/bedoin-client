...
import { useGetDripQuery, useUpdateDripMutation } from '../../../../store/api/drip.api';
import { useForm } from 'react-hook-form';
import DropZoneUpdate from '../../../DropZone/DropZoneUpdate';
import { addInfo, changeInfo, removeInfo } from '../../../helpers/handleInfo';
const UpdateDrip = () => {
    const {id} = useParams();
    let {data, isLoading} = useGetDripQuery({id});
    const navigate = useNavigate();
    const [updateDrip] = useUpdateDripMutation();
    const {
        register,
        formState: {
            errors,
                    ...
                    <div className="admin-product__update update-product">
                        ...
                        <form className='update-product__form form-update' onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='form-update__drop'>
                                <DropZoneUpdate files={files} setFiles={setFiles} title={'Drips'} old={oldImgs} setOld={setOldImgs}/>
                            </div>
