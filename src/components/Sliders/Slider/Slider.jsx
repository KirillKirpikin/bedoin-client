            ...
            {!data.length ? <SpinerImg/> : (
                ...
                >
                    ...
                    <div className='main-slider__navigation'>
                        <div className='main-slider__prev' onClick={()=>handleButtonClick(PREV)} ><ArrowSvg/></div>
                        <div className='main-slider__next' onClick={()=>handleButtonClick(NEXT)} ><ArrowSvg/></div>
                    </div>
                </Swiper>
            ) }            
        </div>
