    ...
    return (
        <div className={`dropdown__menu ${open ? "dropdown__menu-active" : ""}`} >
            <ul >
                ...
                <li>
                    <Link className='dropdown__link' to={ROUTES.LEMONADE} onClick={()=>{handleClose()}} >Lemonade</Link>
                </li>
                {isAuth && (
                    <li>
                        <Link className='dropdown__link' to={ROUTES.ADMIN} onClick={()=>{handleClose()}} >Adminka</Link>
                    </li>
                    )
                }
            </ul>
