    ...
    return (
        <div className="cart__product product-cart">
            <div className="product-cart__main">
                <Link
                    to={linkTo(cart.product, cart._id)}
                ...
                <div className="product-cart__info">
                    ...
                    <div className="product-cart__select">
                        Упаковка: <span>{cartPacking(cart.packing)}</span>
                    </div>
                    <div className="product-cart__bottom">
                        ...
                        <div className="product-cart__total">
                            {cart.product === "drip"
                                ? (isDiscounted || isDiscountedDrip) && (
                                      <div className="product-cart__total product-cart__total-old">
                                          {+cart.price.regular * count}
                                      </div>
                                  )
                                : cart.product === "coffee"
                                ? isDiscounted && (
                                ...
                                : cart.product === "lemonade"
                                ? (isDiscounted || isDiscountedLemonade) && (
                                      <div className="product-cart__total product-cart__total-old">
                                          {+cart.price.regular * count}
                                      </div>
                                  )
                                : null}
                            <div className="product-cart__total product-cart__total-actual">
                                {totalActual(cart)} ₴
                            </div>
                        </div>
                    </div>
                ...
                <div
                    ...
                    onClick={() =>
                        removeItem(cart._id + cart.select + cart.packing)
                    }
                >
                    <CloseSvg />
                </div>
